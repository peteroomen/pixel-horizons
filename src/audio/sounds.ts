...
//
// zzfx parameter order: volume, randomness, frequency, attack, sustain, release,
//   shape (0=sine 1=square 2=saw 3=triangle 4=tan), slide, deltaSlide,
//   pitchJump, pitchJumpTime, repeatTime, noise, modulation, bitCrush,
//   delay, sustainVolume, decay, tremolo
...
export const hullHit = () =>
  //        vol   rnd   freq  atk   sus   rel   shp  slide  dSlide  pJ  pJT  repT  noise
  play(0.7, 0.1, 80, 0, 0.04, 0.22, 3, -2.5, 0, 0, 0, 0, 0.15);

/** Enemy hit — organic wet smack (Bloom flesh, not metal). */
export const enemyHit = () =>
  //        vol   rnd   freq  atk   sus   rel   shp  slide  dSlide  pJ  pJT  repT  noise
  play(0.5, 0.15, 160, 0, 0.03, 0.14, 0, -4, 0, 0, 0, 0, 0.3);
...
export const shieldUp = () =>
  //        vol   rnd  freq  atk   sus   rel   shp  slide
  play(0.35, 0, 520, 0.02, 0.04, 0.12, 0, 2);

/** Shield layer broken — crackling discharge. */
export const shieldBreak = () =>
  //        vol   rnd   freq  atk   sus   rel   shp  slide  dSlide  pJ  pJT  repT  noise
  play(0.55, 0.1, 300, 0, 0.05, 0.2, 2, -3.5, 0, 0, 0, 0, 0.2);
...
export const victory = () =>
  //        vol  rnd  freq  atk   sus   rel   shp  slide  dSlide  pJ   pJT  repT
  play(0.5, 0, 280, 0, 0.06, 0.12, 0, 0, 0, 0, 0, 0.18);

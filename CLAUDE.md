...
- **Last session:** 2026-06-22 — **PORTRAIT REDESIGN** (see above). 562 tests green. Branch `feature/mining-portrait-redesign`, PR #36 open stacked on `feature/mining-v2-slice-a` (PR #35).
